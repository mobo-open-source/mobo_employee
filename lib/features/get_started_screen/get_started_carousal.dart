...
class _GetStartedScreenState extends State<GetStartedScreen> {
  String _getImagePath(String baseName) {
    return 'assets/getstarted/$baseName.jpg';
  }

  late final List<Map<String, String>> onboardingData = [
    {
      'image': _getImagePath('01'),
      'title': 'All Your Employee Data\nin One Place',
      'description':
          'View your profile, track attendance, check leaves, and stay updated seamlessly',
    },
    {
      'image': _getImagePath('02'),
      'title': 'Connected to Odoo HR',
      'description':
          'Real-time sync with your company Odoo system keeps all HR records up-to-date',
    },
    {
      'image': _getImagePath('03'),
      'title': 'Manage Time Off\n& Leave Requests',
      'description':
          'Request time off, check leave balances, and track your manager approvals from anywhere',
    },
  ];
      ...
      body: LayoutBuilder(
        builder: (context, constraints) {
          if (isDesktop) {
                    ...
                    child: Center(
                      child: SingleChildScrollView(
                        ...
                        child: ConstrainedBox(
                          ...
                          child: _buildContent(theme, isDesktop: true),
                        ),
                      ),
                    ),
                  ),
                    ...
                    child: Center(
                      child: SingleChildScrollView(
                        ...
                        child: ConstrainedBox(
                          ...
                          child: _buildContent(theme, isDesktop: false),
                        ),
                      ),
                    ),
                  ),
            ...
            return Stack(
              children: [
                _buildCarousel(theme, height, width, isDesktop: false),
                SafeArea(
                  child: Padding(
                    padding: EdgeInsets.symmetric(
                    ...
                    child: Column(
                      children: [
                        ...
                        Column(
                          ...
                          children: [_buildContent(theme, isDesktop: false)],
                        ),
                      ],
                    ),
                  ),
  ...
  Widget _buildContent(ThemeData theme, {required bool isDesktop}) {
