...
###  Time-Off Allocation
- **Allocate Leaves**: Assign time-off allocations to employees across different leave types.
- **Allocation Tracking**: View, edit, and track existing allocations and remaining balances.
- **Multiple Leave Types**: Support for various leave categories configured in Odoo.
- **Allocation History**: Full visibility into past and active allocations per employee.

###  Manager Validation
- **Leave Request Validation**: Approve or refuse employee leave requests directly from the app.
- **Allocation Validation**: Validate or refuse time-off allocation requests submitted by employees.
- **Multi-Level Approvals**: Support for Odoo's standard two-stage validation workflows.
- **Audit Trail**: Track every approval action with timestamps and validator details.
...
- Website: [cybrosys.com/mobo](https://www.cybrosys.com/mobo/)
